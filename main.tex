...
\section{Work Experience}
    \resumeSubheadingListStart
        ...
        \resumeItemListStart
            \resumeItem{Prepared food in order to prepare the restaurant for opening and served food to customers.}
        \resumeItemListEnd
    \resumeSubheadingListEnd
...
\section{Projects}
    \resumeSubheadingListStart
        ...
        {\textbf{Dragonfly} $|$ \emph{Python, SQLAlchemy, FastAPI}}{}
        \resumeItemListStart
            \resumeItem{Dragonfly automatically scans new releases on the Python Package Index for malicious files.}
            \resumeItem{Designed a distributed client-server model which focused on scalability and fault tolerance.}
            \resumeItem{Collaborate with a team of 30 other developers, cybersecurity experts, and DevOps engineers.}
            \resumeItem{Successfully reported over 500 malicious packages so far.}
            \resumeItem{\dots}
        \resumeItemListEnd
