...
\section{Projects}
    \resumeSubheadingListStart
        ...
        \resumeItemListStart
            % Merge bullets 2,3; 1-indexed
            \resumeItem{VipyrSec automatically scans new releases on the Python Package Index (PyPI) for malicious signatures.}
            \resumeItem{Among the fastest and most consistent reporters for malicious packages according to PyPI's Director of Infrastructure.}
