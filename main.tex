...
\section{Projects}
    \resumeSubheadingListStart
        \resumeProjectHeading
        {\textbf{Blog} $|$ \emph{Rust, Docker, Github Actions, Grafana, nginx, HTML and CSS}}{}
        \resumeItemListStart
        ...
        \resumeProjectHeading
        {\textbf{Cryptograms} $|$ \emph{Rust, GraphQL, Docker, PostgreSQL}}{}
        \resumeItemListStart
        ...
        \resumeProjectHeading
        {\textbf{LiveCC (OwlHacks 2023)} $|$ \emph{Java, Python, FastAPI, Redis, JavaFX, Apache HttpClient, Maven, Docker}}{}
        \resumeItemListStart
        ...
        %\resumeProjectHeading
        %{\textbf{HTTP Server} $|$ \emph{C, pthread.h}}{}
        %\resumeItemListStart
        %    \resumeItem{}
        %    \resumeItem{}
        %    \resumeItem{}
        ...
        \resumeProjectHeading
        {\textbf{Conway's Game of Life} $|$ \emph{Python, Rust, rust-cpython, arcade}}{}
        \resumeItemListStart
        ...
        \resumeProjectHeading
        {\textbf{Sorting Algorithm Visualizer} $|$ \emph{Java, swing, awt}}{}
        \resumeItemListStart
