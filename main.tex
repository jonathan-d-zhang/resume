...
\section{Work Experience}
    \resumeSubheadingListStart
        ...
        \resumeItemListStart
            ...
            \resumeItem{Migrate internal VB.net web apps to Blazor Webassembly.}
            \resumeItem{Documented the on-boarding process, creating a single source of information for new hires in the DBA team.}
            \resumeItem{Decreased website load times by over 50\%.}
%            \resumeItem{\dots}
%            \resumeItem{\dots}
%            \resumeItem{\dots}
        \resumeItemListEnd
...
\section{Projects}
    \resumeSubheadingListStart
        \resumeProjectHeading{\textbf{Dragonfly} $|$ \emph{Python, SQLAlchemy, FastAPI, Rust, Auth0, Azure App Service}}{}
        \resumeItemListStart
            ...
            \resumeItem{Worked directly with the Python Software Foundation to improve malware reporting infrastructure.}
        \resumeItemListEnd
