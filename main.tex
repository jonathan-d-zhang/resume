...
\section{Work Experience}
    \resumeSubheadingListStart
        \resumeSubheading{Epicor}{May 2023 -- Aug 2023}{Database Developer Intern}{}
    \resumeSubheadingListEnd
...
\section{Projects}
    \resumeSubheadingListStart
        ...
        {\textbf{Dragonfly} $|$ \emph{Python}}{}
        \resumeItemListStart
            \resumeItem{Dragonfly automatically scans package updates on PyPI for malicious files.}
            \resumeItem{Collaborated with a team of 5 others to \dots}
            \resumeItem{Message queues blah \dots}
            \resumeItem{Successfully reported over 300 malicious packages.}
            \resumeItem{\dots}
        \resumeItemListEnd
